                    ...
                    <div className="flex md:flex-row flex-col gap-9 text-[#5C5C5C] text-xs md:mt-3 mt-10">
                        <div className="flex flex-col gap-2 items-start">
                            ...
                            <button className='hover:text-red-600 hover:underline'>
                                ...
                                <button onClick={(e) => handleClick('/about/our-team')} className='hover:text-red-600 hover:underline'>
                                    The Team
                                </button>
                                <button onClick={(e) => handleClick('/about/what-we-do#history')} className='hover:text-red-600 hover:underline'>
                                    History
                                </button>
                                <button onClick={(e) => handleClick('/competitions')} className='hover:text-red-600 hover:underline'>
                                    Awards
                                </button>                        
                        </div>
                        ...
                        <div className="flex flex-col gap-2 items-start">
                            ...
                            {currentProjects.map((project) => (
                                <button
                                key={project.slug}
                                onClick={(e) => handleClick(`/projects/${project.slug}`)}

...
const Careers = () => {
    const careerspage = (
        <div className="w-full bg-white">
            {/* First Section */}
            <div className="w-full min-h-[485px] px-8 py-12 md:px-16 md:py-24 bg-white flex flex-col justify-center items-center gap-8">
                <div className="text-center max-w-4xl">
                    <div className="text-[#d00200] text-base font-semibold font-['Inter'] mb-2">Join Our Team</div>
                    <div className="text-[#181818] text-3xl md:text-4xl font-semibold font-['Inter'] mb-4">Careers at Enactus</div>
                    <div className="text-[#181818] text-lg md:text-xl font-normal font-['Inter'] leading-relaxed mb-4">
                        Join us in making an impact in our community through entrepreneurial action.
                    </div>
                    <div className="inline-flex">
                        <div className="px-4 py-2 bg-[#d00200] rounded-full flex justify-center items-center">
                            <div className="text-white text-sm font-semibold font-['Inter']">Hiring Package</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Second Section */}
            <div className="w-full min-h-[520px] px-8 pb-12 md:px-16 md:pb-24 bg-white flex flex-col justify-center items-center gap-8">
                <div className="text-center max-w-4xl">
            ...
            {/* Third Section */}
            <div className="w-full min-h-[3357px] px-8 pb-12 md:px-16 md:pb-24 bg-white flex flex-col justify-start items-center gap-12">
                {/* Organization Culture */}
                <div className="w-full max-w-6xl h-auto bg-white flex flex-col justify-start items-start gap-8 p-8">
                    <img src={GroupPhoto} alt="Organization Culture" className="w-full h-auto" /> 
                    <div className="text-center text-[#181818] text-2xl md:text-3xl font-semibold font-['Inter'] mb-4">☕ Organization Culture</div>
                    <div className="text-[#181818] text-base md:text-lg font-normal font-['Inter'] leading-relaxed">
                ...
                <div className="w-full max-w-6xl flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="h-[148px] bg-white rounded-xl border border-[#d7d7d7] flex flex-col justify-start items-start p-4 md:p-8">
                            <div className="flex items-start gap-4">
                                <img src={ReviewRole} alt="Review the Role" className="w-12 h-12" /> 
                                <div className="flex-1">
                                    <div className="text-[#181818] text-lg font-medium font-['Inter']">Review the role</div>
                                    <div className="text-[#5c5c5c] text-sm font-normal font-['Inter'] leading-relaxed">
                                        Before your interview, carefully read through the job description to understand the expectations and responsibilities. This will help you align your experiences and skills with what we’re looking for.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-[148px] bg-white rounded-xl border border-[#d7d7d7] flex flex-col justify-start items-start p-4 md:p-8">
                            <div className="flex items-start gap-4">
                                <img src={MagnifyingGlass} alt="Showcase your Research" className="w-12 h-12" /> 
                                <div className="flex-1">
                                    <div className="text-[#181818] text-lg font-medium font-['Inter']">Showcase your research</div>
                                    <div className="text-[#5c5c5c] text-sm font-normal font-['Inter'] leading-relaxed">
                                        We appreciate candidates who take the time to learn about Enactus SFU. Research our current projects, values, and the impact we’re making in the community. Understanding our mission and how we operate will allow you to speak confidently about why you want to be part of Enactus SFU. Explore our Enactus SFU Projects page to get insights into our ongoing initiatives. Knowing how your role contributes to these projects is a great way to demonstrate your fit with our team.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-[148px] bg-white rounded-xl border border-[#d7d7d7] flex flex-col justify-start items-start p-4 md:p-8">
                            <div className="flex items-start gap-4">
                                <img src={Heart} alt="Focus on your fit and contribution" className="w-12 h-12" /> 
                                <div className="flex-1">
                                    <div className="text-[#181818] text-lg font-medium font-['Inter']">Focus on your fit and contribution to our culture</div>
                                    <div className="text-[#5c5c5c] text-sm font-normal font-['Inter'] leading-relaxed">
                                        At Enactus SFU, we value not only skills and experience but also personality and cultural fit. We aim to build a team where lifelong connections are formed. Showcase how you can contribute to our community and why you believe you’d be a great addition to our team. Let your personality shine through!
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-[148px] bg-white rounded-xl border border-[#d7d7d7] flex flex-col justify-start items-start p-4 md:p-8">
                            <div className="flex items-start gap-4">
                                <img src={Clock} alt="Clarify and take your time" className="w-12 h-12" /> 
                                <div className="flex-1">
                                    <div className="text-[#181818] text-lg font-medium font-['Inter']">Clarify and take your time</div>
                                    <div className="text-[#5c5c5c] text-sm font-normal font-['Inter'] leading-relaxed">
                                        If you don’t understand a question, ask for clarification or request it to be rephrased. Don’t hesitate to take a moment to gather your thoughts before responding. We value clear and thoughtful communication.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-[148px] bg-white rounded-xl border border-[#d7d7d7] flex flex-col justify-start items-start p-4 md:p-8">
                            <div className="flex items-start gap-4">
                                <img src={Questionmark} alt="Bring your questions" className="w-12 h-12" /> 
                                <div className="flex-1">
                                    <div className="text-[#181818] text-lg font-medium font-['Inter']">Bring your questions</div>
                                    <div className="text-[#5c5c5c] text-sm font-normal font-['Inter'] leading-relaxed">
                                        Your curiosity matters to us. Use this opportunity to learn more about Enactus SFU, our projects, and the team. We’re eager to answer your questions and provide you with a deeper understanding of our organization.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-[1920px] h-[459px] px-80 py-[120px] bg-[#fbfbfb] flex-col justify-start items-center gap-12 inline-flex">

    ...
    const secondsavour = (
        <main className = 'mt-4'>
            ...
            <div className = 'flex flex-col gap-16'>
                    <div className="lg:mx-60 currentProject-md:mx-40 sm:mx-16 mx-10 bg-white flex flex-col items-center gap-5 pt-12">
                    ...
                    <div className="flex flex-col justify-start items-start gap-4 currentProject-md:mx-96 currentProjectText-md:mx-80 currentProjectText-mx:mx-48 sm:mx-28 mx-8 ">
                    ...
                    <div className = 'currentProject-md:mx-96 currentProjectText-md:mx-80 currentProjectText-mx:mx-48 sm:mx-28 mx-8 '>
                    ...
                    <div className="flex flex-col justify-start items-start gap-4 currentProject-md:mx-96 currentProjectText-md:mx-80 currentProjectText-mx:mx-48 sm:mx-28 mx-8 mb-20">

...
import grate from '../images/currentprojects/grate.png'; 
import render from '../images/currentprojects/render.png'; 
import last from '../images/currentprojects/last.png'; 
import filter from '../images/currentprojects/filter.png'; 
...
const BeeKind = () => {
  ...
  <div className="w-full max-w-5xl flex flex-col justify-start items-center gap-8">
    ...
    <div className="flex justify-center items-center gap-4 md:gap-6">
      <div className="px-4 md:px-5 py-3 md:py-4 bg-[#d00200] rounded-full flex items-center justify-center cursor-pointer">
        <div className="text-white text-sm font-semibold">Visit Website</div>
      </div>
      <div className="px-4 md:px-5 py-3 md:py-4 bg-[#181818] rounded-full flex items-center justify-center cursor-pointer">
        <div className="text-white text-sm font-semibold">Our Instagram</div>
      </div>
    </div>
  </div>
</div>
...
<div className="w-full h-auto px-4 md:px-12 lg:px-24 py-12 lg:py-24 bg-[#fbfbfb] flex flex-col justify-start items-center gap-12 lg:gap-24 mx-auto">
  ...
  <div className="w-full max-w-5xl flex flex-col md:flex-row justify-between items-start gap-8 lg:gap-24">
    <div className="flex flex-col justify-start items-center gap-4 text-center">
      <div className="w-8 h-8 relative rounded-full">
    <img className="w-full h-full object-cover" src={leaf} alt="leaf" />
    ...
    <img className="w-full h-full object-cover" src={communityicon} alt="communityicon" />
  ...
  <div className="w-8 h-9 relative rounded-full">
    <img className="w-full h-full object-cover" src={pollen} alt="Pollen" />
  </div>
...
<div className="w-full h-auto px-4 md:px-12 lg:px-24 py-12 lg:py-24 bg-white flex flex-col justify-start items-center gap-12 lg:gap-24 mx-auto">
  <div className="w-full max-w-5xl flex flex-col justify-start items-start gap-10">
    <div className="flex justify-between items-center w-full">
      <div className="text-[#181818] text-[24px] md:text-[32px] font-semibold">Our Candles</div>
      <div className="px-5 py-4 bg-[#d00200] rounded-full flex items-center cursor-pointer">
        <div className="text-white text-sm font-semibold">Shop Now</div>
      </div>
    </div>
...
<div className="w-full max-w-4xl flex flex-col justify-start items-center gap-6 text-center">
  ...
  <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    <div className="w-full bg-white rounded-xl border border-[#ebebeb] flex flex-col justify-start items-center overflow-hidden">
      <div className="relative w-full h-fill md:h-full rounded-t-xl border-8 border-white">
      <img className="w-full h-[384px] object-cover" src={grate} alt="BeeKind Candle" />

      </div>
      <div className="w-full p-4 bg-white text-center">
        <div className="text-[#181818] text-lg font-medium">Grate</div>
      </div>
    </div>

    <div className="w-full bg-white rounded-xl border border-[#ebebeb] flex flex-col justify-start items-center overflow-hidden">
    <div className="relative w-full h-fill md:h-full rounded-t-xl border-8 border-white">
      <img className="w-full h-[384px] object-cover" src={render} alt="BeeKind Candle" />

      </div>
      <div className="w-full p-4 bg-white text-center">
        <div className="text-[#181818] text-lg font-medium">Boil</div>
      </div>
    </div>

    <div className="w-full bg-white rounded-xl border border-[#ebebeb] flex flex-col justify-start items-center overflow-hidden">
    <div className="relative w-full h-fill md:h-full rounded-t-xl border-8 border-white">
      <img className="w-full h-[384px] object-cover" src={filter} alt="BeeKind Candle" />

      </div>
      <div className="w-full p-4 bg-white text-center">
        <div className="text-[#181818] text-lg font-medium">Filter</div>
      </div>
    </div>

    <div className="w-full bg-white rounded-xl border border-[#ebebeb] flex flex-col justify-start items-center overflow-hidden">
    <div className="relative w-full h-fill md:h-full rounded-t-xl border-8 border-white">
      <img className="w-full h-[384px] object-cover" src={last} alt="BeeKind Candle" />

      </div>
      <div className="w-full p-4 bg-white text-center">
        <div className="text-[#181818] text-lg font-medium">Render</div>
      </div>
    </div>
  </div>
</div>
<div className="flex flex-col md:mx-28 lg:mx-40 sm:mx-16 mx-10 md:gap-32 sm:gap-20 gap-10 md:mb-32 sm:mb-20 mb-10">
  ...
  <div className="w-full max-w-4xl flex flex-col justify-start items-center gap-6 text-center">
    ...
    <div className="px-5 py-4 bg-[#d00200] rounded-full flex items-center justify-center cursor-pointer">
      <div className="text-white text-sm font-semibold">Shop now</div>
    </div>
  </div>
</div>
